...
class HelloGroovy {
    static void main(String[] args) {
        ...
        println("Big float " + Float.MAX_VALUE)
        ...
        // Long arithmetic
        println 1111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 + 11111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111

        // Math and Random libs
        def randNum = 2.0
        println("Math.abs(-2.45) = " + (Math.abs(-2.45)))
        println(randNum.pow(3))
        println(randNum.equals(Float.NaN))
        println(Math.round(2.34))

        // And many other functions from Math
        def rand = Math.random()
        def rand_int = new Random().nextInt()
...
some lines'''
        ...
        println("3rd Index pf Name " + name[3]);
        println("Index of r " + name.indexOf('r'))
        println("1st 3 chars " + name[0..3])
        println(name.substring(1,4))
        println(name.concat(" Aaaa" * 5))
        println('== ' + (name == 'Danil'))
        println('.equals + ' + (name.equals('Danil')))
